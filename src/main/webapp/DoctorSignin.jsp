    ...
    <body>
        ...
        <div>
            <div class="signupcontainer">
                <h2>Doctor Sign-In with your account</h2>
                <h3>Doctor Sign-in with email</h3>
                <form>
                    <label>Email</label><br/>
                    <input type="email" placeholder="Enter Email-ID (Doctor)" name="email"/><br/><br/>
                    ...
                    <%
                        ...
                        if(email!=null && password!=null)
                        {
                            ...
                            ResultSet rs = stmt.executeQuery("select * from  DoctorDetails");
                            while(rs.next()){
                ...
                <p style="font-family: 'Georgia'; font-size: 14px;">New member, <a href="DoctorSignup.jsp">Sign Up</a></p>
                <p style="font-family: 'Georgia'; font-size: 14px;">User, <a href="signin.jsp">Sign In</a></p>
            </div>
        </div>
    </body>
</html>