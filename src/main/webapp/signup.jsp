    ...
    <body>
        ...
        <div>
            <div class="signupcontainer">
                    ...
                    <%
                        ...
                        if(email!=null && password!=null && repass!=null && !email.equals("") && !password.equals("") && !repass.equals("") && !fname.equals("") && !lname.equals(""))
                        {
                            if(password.equals(repass))
                            {
                                ...
                                try{
                                    stmt.executeUpdate("insert into UserDetails values('"+fname+"','"+lname+"','"+email+"','"+password+"')");
                ...
                <p style="font-family: 'Georgia'; font-size: 16px;">Already a member, <a href="signin.jsp">Sign In</a></p>
            </div>
        </div>
    </body>
</html>